...
const anchorNew =
  "e=this.getImage(r))," +
  goodCond +
  "((function(){try{this.addImage(r,{data:new t.R({width:1,height:1},new Uint8Array(4)),pixelRatio:1,sdf:!1,version:0})}catch(t){}}.call(this)),e=this.getImage(r)),e?o[r]={data:e.data.clone(),pixelRatio:e.pixelRatio,sdf:e.sdf,version:e.version,stretchX:e.stretchX,stretchY:e.stretchY,content:e.content,textFitWidth:e.textFitWidth,textFitHeight:e.textFitHeight,hasRenderCallback:Boolean(null===(i=e.userImage)||void 0===i?void 0:i.render)}" +
  ':t.w(`Image "${r}" could not be loaded.';

let s = fs.readFileSync(distPath, "utf8");

if (s.includes(badLegacy)) {
  s = s.replace(badLegacy, goodCond);
  fs.writeFileSync(distPath, s, "utf8");
  console.log("patch-maplibre-dist: migrated legacy empty-id patch");
  process.exit(0);
}

if (s.includes(goodCond)) {
